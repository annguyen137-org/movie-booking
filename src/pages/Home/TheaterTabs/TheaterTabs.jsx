      ...
      <div className={`hidden lg:block container mx-auto text-center px-5 md:px-10 lg:px-40 py-10 `} ref={theatersRef}>
        <div className={`border border-slate-300`}>
          <Tabs tabPosition="left" tabBarStyle={{ height: "500px", overflow: "hidden" }}>
            {theatersBrand.map((brand) => {
              return (
                <Tabs.TabPane
                  className="p-0"
                  tab={
                    <div className="brand-img">
                      <img width={40} height={40} src={brand.logo} alt={brand.tenHeThongRap} title={brand.tenHeThongRap} />
                    </div>
                  }
                        ...
                        <Tabs.TabPane
                          ...
                          tab={
                            <div className="px-2 text-left max-w-xs transition-colors active:bg-slate-400">
                              <div className="flex flex-col justify-start items-start border-b border-gray-300" title={theater.diaChi}>
                              ...
                              return (
                                <div key={film.maPhim} className="py-2 px-5 flex border border-gray-300 h-60 max-h-60">
                                  <div className="mr-4 h-full">
                                    <img width={200} src={film.hinhAnh} alt={film.tenPhim} className="h-full object-cover" />
                                  </div>
                                        ...
                                        return (
                                          ...
                                          >
                                            ...
                                            <div className="text-bold hover:text-white">
                                              <p className="m-0">
                                                Ngày: {[...showtime.ngayChieuGioChieu.split("T")[0].split("-")].reverse().join("-")}
                                              </p>
                                              <p className="m-0">Giờ: {showtime.ngayChieuGioChieu.split("T")[1].slice(0, 5)}</p>
                                            </div>
                                          </div>
                                        );
                                      })}
